...
class ProfileHeaderView: UIView {
    ...
    private func layout() {
        [imageView, fullNameLabel, statusLabel, setStatusButton].forEach{addSubview($0)}
        ...
        NSLayoutConstraint.activate([
            ...
            fullNameLabel.leadingAnchor.constraint(equalTo: imageView.trailingAnchor, constant: 27)
        ])
        ...
        NSLayoutConstraint.activate([
            statusLabel.leadingAnchor.constraint(equalTo: imageView.trailingAnchor, constant: 27),
